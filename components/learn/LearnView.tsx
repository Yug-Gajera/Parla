...
import { ReviewSession } from '../vocabulary/ReviewSession';
...
export default function LearnView({ languageId, languageName, level }: LearnViewProps) {
    ...
    return (
        <div className="flex flex-col w-full h-full relative">
            ...
            {/* Main Tabs UI */}
            <Tabs defaultValue="vocabulary" className="w-full flex-1 flex flex-col h-full">
                ...
                <div className="flex items-center justify-between px-4 md:px-8 py-6 pb-2">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Review your {languageName} ({level}) vocabulary and grammar.</p>
                    </div>
